export const GAME_PROMPTS = {
  INITIAL_STORY: `You are the narrator of an interactive adventure in an anime fantasy world, similar to Demon Slayer. Avoid and DON'T use the same Demon Slayer characters.
